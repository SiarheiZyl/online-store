...
<div class="panel panel-default panel-order " >
    ...
    <div class="panel-body" >
        <div class="row" style="margin-left: 10%; margin-top: 2%; margin-right: 10%">
            ...
            <div class="col-md-4">
                <h3 class="display-5 pull-right">Month: <span style="color:darkslateblue;">$${incomeMap.get("month")}</span></h3>
            </div>
        </div>
                <div class="row" style="margin-left: 10%; margin-top: 2%;">
                    <div class="col-md-6">
                        ...
                        <div class="row" style="margin-top: 10px">
                            <div class="col-md-2">
                            <img src="http://www.gravatar.com/avatar/${MD5Util.md5Hex(user.key.email)}" class="media-object img-thumbnail">
                            </div>
                            <div class="col-md-4">
